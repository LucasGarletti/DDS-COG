...
type Event struct {
	...
	IsFestival        bool               `json:"is_festival" gorm:"not null;default:false"`
	Tickets           []Ticket           `json:"tickets,omitempty" gorm:"foreignKey:EventID"`
	Schedules         []FestivalSchedule `json:"schedules,omitempty" gorm:"foreignKey:EventID"`
	Itineraries       []UserItinerary    `json:"itineraries,omitempty" gorm:"foreignKey:EventID"`
